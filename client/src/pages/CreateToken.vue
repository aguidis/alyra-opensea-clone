...
<template>
    <main>
        ...
        <div v-if="step === 1" class="max-w-6xl mx-auto pt-32 px-4 xl:px-0">
            <h1 class="h2 font-bold mb-6">Create New Item</h1>

            <div class="p-2 mb-10 bg-indigo-800 items-center text-indigo-100 leading-none md:rounded-full flex lg:inline-flex" role="alert">
                <span class="flex md:rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">Frozen metadata</span>
        ...
        <div v-else class="max-w-6xl mx-auto px-4 sm:px-6 text-center pt-20 lg:pt-32">
