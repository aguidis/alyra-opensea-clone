        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
                <ul class="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                    <li class="ml-4">
                        <a href="https://github.com/aguidis/alyra-opensea-clone" class="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                ...
                <div class="flex justify-center items-center">
                    ...
                    <span class="text-sm text-gray-600">AlyraSea. All rights reserved.</span>
                </div>
            </div>
        </div>
    </footer>
